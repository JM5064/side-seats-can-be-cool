...
app = Flask(__name__)
CORS(app, supports_credentials=True, origins=["http://localhost:5173", "https://jm5064.github.io/side-seats-can-be-cool", "https://side-seats-can-be-cool.onrender.com/"],)
